...
//                "text/javascript, text/html, application/xml, application/json, text/xml, */*");
        ...
        //setRequestHeader("Referer", "https://www.avnet.com/wps/portal/apac/");
        setRequestHeader("Host", "https://www.avnet.com/");

        setRequestHeader("Referer", "https://www.avnet.com/shop/us/c/connectors/connector-accessories/backshells/");
    }
