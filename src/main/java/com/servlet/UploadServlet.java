...
public class UploadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
      ...
      //  String str = "C:\\Users\\PC\\Desktop\\task.txt";
        ...
        try {
            ...
            if (formItems != null && formItems.size() > 0) {
                ...
                for (DiskFileItem item : formItems) {
                    // 处理不在表单中的字段
                    if (!item.isFormField()) {
                        String saveName = new StringBuffer(item.getName()).toString();
                        ...
                        if(ftpClient!=null){
                            boolean result=FTPUtils.upload(ftpClient,workingPath, fileInputStream, saveName);
